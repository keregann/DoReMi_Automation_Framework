...
import com.endava.doremi_automation_framework.pageObject.BasePage;
...
public class ReflectionManager {
    ...
    public static boolean pageInit(String pageName) throws Exception {
        ...
        try {
            currentPageClass = Class.forName("com.endava.doremi_automation_framework.pageObject." + pageName + "Page");
