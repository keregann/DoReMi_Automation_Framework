...
//        Assert.assertTrue(webElement.isDisplayed()); //assertThat
...
//        List<TableData> tableData = table.asList(TableData.class);
...
//                        log.info(t.value + " is entered into " + t.key.toUpperCase());
//                        Thread.sleep(2000);
//                    } else {
//                        webElement.clear();
//                        drawBorder(webElement);
...
//    }
//
//    private static void setCurrentPage(String cucumberPageName) throws Exception { //Home Page
...
//        for (Method meth : currentPageMethods) {
//            if (meth.getName().equalsIgnoreCase("get" + elementToCompare)) { //getHomePage
//                webElement = (WebElement) meth.invoke(currentPageClass.newInstance());
